...
```bash
cd PS69-Weather-Analytics
python3 -m uvicorn phase5.api.main:app --reload --host 0.0.0.0 --port 8000
```
...
from phase5.api.db import Base, engine
...
python3 -m uvicorn phase5.api.main:app --port 8001
...
pytest phase5/tests/ -v --tb=short
```

### Adding New Routes

1. Create handler in `phase5/api/routes/`
2. Import and include in `phase5/api/main.py`
3. Add tests to `phase5/tests/`
4. Check documentation in `API.md`

### Database Schema Changes

1. Update `phase5/api/models.py`
2. Update `phase5/db/schema.sql` if needed
...
3. Run tests: `pytest phase5/tests/ -v`
