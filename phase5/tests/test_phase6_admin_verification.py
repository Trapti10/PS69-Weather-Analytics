...
- Persistence (18-20)
- Regression (21) is verified separately by running the whole phase5/tests/
...
from phase5.api.models import User, WeatherEvent, WeatherReport, AdminReviewAction, AuditLog
